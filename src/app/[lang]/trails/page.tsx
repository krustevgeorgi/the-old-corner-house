    ...
    <div className="pt-14">
      ...
      <div className="px-6 py-5 space-y-5">
        ...
        {content.items.map((trail, i) => (
          ...
          >
            <div className="bg-warm px-5 py-3.5 print:bg-gray-100">
            ...
            <div className="p-5 space-y-3.5 bg-white">
              ...
              <div className="p-3 rounded-xl bg-warm-light border border-border print:bg-white">
              ...
              <div>
                <p className="text-xs font-medium text-text-muted mb-1 uppercase tracking-wider print:text-black">
